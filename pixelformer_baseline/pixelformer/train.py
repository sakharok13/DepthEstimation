...
parser.add_argument('--experiment_number', type=str,   help='serial number of your experiment', default='DepthFormer')

wandb.init(project=Config.project + parser.parse_args().experiment_number)
...
def main_worker(gpu, ngpus_per_node, args=args):
    args.gpu = gpu
